...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="domain" htmlEscape="false" maxlength="100" class="required"/>
				<span class="help-inline"><font color="red">*</font>例如：www.hisw.cn</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">站点logo:</label>
			<div class="controls">
				<button class="file" type="button" id="logoID" fileType="pic" value="${office.logo}" ><span class="glyphicon glyphicon-plus"><span>添加</button>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>				
		<div class="control-group">
