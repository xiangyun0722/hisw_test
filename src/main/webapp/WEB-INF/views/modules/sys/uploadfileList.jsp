...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/uploadfile/">上传文件列表</a></li>
		<shiro:hasPermission name="sys:uploadfile:edit"><li><a href="${ctx}/sys/uploadfile/form">上传文件添加</a></li></shiro:hasPermission>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				<th>更新时间</th>
				<th>备注信息</th>
				<shiro:hasPermission name="sys:uploadfile:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="uploadfile">
			<tr>
				<td><a href="${ctx}/sys/uploadfile/form?id=${uploadfile.id}">
				...
				<shiro:hasPermission name="sys:uploadfile:edit"><td>
					...
					<a href="${ctx}/sys/uploadfile/delete?id=${uploadfile.id}" onclick="return confirmx('确认要删除该上传文件吗？', this.href)">删除</a>
