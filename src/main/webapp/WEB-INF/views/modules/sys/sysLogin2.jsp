...
<body>
	...
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightYear')} <a href="#">${fns:getConfig('productName')}</a> <%-- - Powered By <a href="http://jeesite.com" target="_blank">JeeSite</a> ${fns:getConfig('version')} --%>
	</div>
