...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/zjvideo/comments/">评论信息列表</a></li>
		<li class="active"><a href="${ctx}/zjvideo/comments/form?id=${comments.id}">评论信息<shiro:hasPermission name="zjvideo:comments:edit">${not empty comments.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="zjvideo:comments:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="comments" action="${ctx}/zjvideo/comments/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="addtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${comments.addtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="topicid" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">用户评论类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="edittime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${comments.edittime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="zjvideo:comments:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
