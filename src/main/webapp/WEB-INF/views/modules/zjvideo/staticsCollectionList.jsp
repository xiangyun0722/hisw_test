...
<body>
	...
	<form:form id="searchForm" modelAttribute="collections" action="${ctx}/zjvideo/collection/statics/collection" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>编号：</label>
				<form:input path="program.teacherno" htmlEscape="false" maxlength="11" class="input-medium"/>
			</li>			
			<li>
				<label>收藏时间：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="collection">
			<tr>
				...
				<td>
					${collection.program.actor}
				</td>
				<td>
					${collection.program.teacherno}
				</td>
				<td>
					${collection.count}
				</td>
