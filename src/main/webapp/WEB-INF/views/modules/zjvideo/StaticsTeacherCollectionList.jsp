...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/zjvideo/collection/statics/teacher/collection">播放历史信息列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="collections" action="${ctx}/zjvideo/collection/statics/teacher/collection" method="post" class="breadcrumb form-search">
