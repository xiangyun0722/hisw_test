...
<body>
	...
	<form:form id="inputForm" modelAttribute="program" action="${ctx}/zjvideo/program/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="ename" htmlEscape="false" maxlength="100" class="input-large "/>
			</div>
		</div>
		<div class="control-group">
...
<%-- 		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="detail" htmlEscape="false" class="required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
...
<%-- 		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">例如: 1.5</span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">发行年份：</label>
			<div class="controls">
				<form:input path="iyear" htmlEscape="false" maxlength="11" class="input-xlarge "/>
				<span class="help-inline">发行年份例如: 2015</span>
			</div>
		</div>		
		<%-- <div class="control-group">
