...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/zjvideo/playHistory/statics/history/">播放历史信息列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="playHistory" action="${ctx}/zjvideo/playHistory/statics/teacher/history" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>讲师编号：</label>
				<form:input path="program.teacherno" htmlEscape="false" maxlength="50" class="input-medium"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="playHistory">
			<tr>
				...
				<td>
					${playHistory.program.actor}
				</td>
				<td>
					${playHistory.program.teacherno}
				</td>								
				<td>
					${playHistory.count}
				</td>
