...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/zjvideo/clazz/class/form">课程二级分类添加</a></li>
	...
	<form:form id="inputForm" modelAttribute="clazz" action="${ctx}/zjvideo/clazz/class/level/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">课程二级分类名称：</label>
			<div class="controls">
