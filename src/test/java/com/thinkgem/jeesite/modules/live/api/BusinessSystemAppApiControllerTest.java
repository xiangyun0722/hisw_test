 ...
 * @version 2016-12-06
 */
public class BusinessSystemAppApiControllerTest{

	private static Logger logger =Logger.getLogger(BusinessSystemAppApiControllerTest.class);
	
	private static String url = "http://127.0.0.1/xjbweb/api/businessSystem/";
